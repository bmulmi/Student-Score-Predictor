...
my_features_names = ['Grade Intro Course', 'Grade Follow Up Course','Grade Fundamentals Course','Grade Systems Course']
...
#set X as the data
X = pd.DataFrame(df, columns = ['Grade Intro Course', 'Grade Follow Up Course','Grade Fundamentals Course']).values

#set y as target data
y = np.where(df['Grade Systems Course'] >= 3.0, 1, 0)
y
